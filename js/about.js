...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const initAnimations = () => {
    ...
    if (window.innerWidth > 1000) {
      // Portrait animation - MOVES UPWARD AND ROTATES at different speeds
      const portraitElement = document.querySelector(".about-hero-portrait");
      if (portraitElement) {
        const portraitAnimation = gsap.to(".about-hero-portrait", {
          y: -450,        // ← Changed from -350 to -450 (moves up more)
          rotation: -35,  // Keep rotation the same
          scrollTrigger: {
            trigger: ".about-hero",
            start: "top top",
            end: "bottom top",
    ...
    // ============================================
    // FIX: Refresh ScrollTrigger after animations
    // ============================================
  ...
  // ============================================
  // FIX: Refresh on load and after delays
  // ============================================
